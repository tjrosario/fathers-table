        ...
        <div class="sec1-right-cols">
          ...
          <div class="sliderinbox <?php echo esc_html($marg_cls); ?>">
            <div class="sliderinborder">
              <?php if( has_post_thumbnail() ) { ?><div class="sliderin-icon"><a
                  href="<?php echo esc_url( get_permalink() ); ?>"><?php echo the_post_thumbnail();?></a></div>
              <?php } ?>
              <div class="sliderintitledes">
                <div class="sliderin-title"><a href="<?php echo esc_url( get_permalink() ); ?>">
                    <h4><?php the_title(); ?></h4>
                  </a></div>
                <div class="sliderin-description"><?php the_excerpt(); ?></div>
              </div>
            </div>
          </div>
        ...
        <div class="services-box">
          <div class="services-box-inner">
            <a href="<?php echo esc_url( get_permalink() ); ?>"
              class="services-box-image"><?php if( has_post_thumbnail() ) { the_post_thumbnail('medium'); } ?></a>
            <h4 class="services-box-title"><a href="<?php echo esc_url( get_permalink() ); ?>"><?php the_title(); ?></a>
            </h4>
    ...
    <section class="site-main">
      <div class="blog-post">
        ...
        <?php
          ...
          $sellingPoints = get_field('selling_points');
        ?>

<!--         <pre>
          <?php // print_r(get_field('selling_points')) ?>
        </pre> -->

        <?php
          foreach ($sellingPoints as $sellingPoint) {
            echo $sellingPoint->post_content;
          }
            
        ?>
        
        <div>
          <img src="<?php echo $bgImage['sizes']['medium'] ?>" />
        </div>
